...
--
-- Servidor: localhost
-- Tiempo de generación: 27-04-2017 a las 23:46:11
...
CREATE TABLE IF NOT EXISTS `ayuda` (
  ...
  `ayuda` varchar(2000) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`idayuda`)
...
CREATE TABLE IF NOT EXISTS `jugadores` (
  ...
  KEY `FKCLUB` (`clubid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=17762 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=21286 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=9474 ;
...
CREATE TABLE IF NOT EXISTS `partidosdetalle` (
  ...
  KEY `EquipoId` (`equipoid`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=444940 ;
...
CREATE TABLE IF NOT EXISTS `sancionesfallos` (
  ...
  KEY `sancionjugadorid` (`sancionjugadorid`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=11017 ;
...
CREATE TABLE IF NOT EXISTS `sancionesjugadores` (
  ...
  KEY `sancionfalloid` (`sancionfalloid`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=58042 ;
