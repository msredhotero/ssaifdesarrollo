...
--
-- Servidor: localhost
-- Tiempo de generación: 15-08-2017 a las 16:21:55
...
--
-- Base de datos: `ssaif_local_agosto`
--
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=1330 ;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dbcambios`
--

CREATE TABLE IF NOT EXISTS `dbcambios` (
  `idcambio` int(11) NOT NULL AUTO_INCREMENT,
  `refdorsalsale` int(11) NOT NULL,
  `refdorsalentra` int(11) NOT NULL,
  `reffixture` int(11) NOT NULL,
  `refequipos` int(11) NOT NULL,
  `refcategorias` int(11) NOT NULL,
  `refdivisiones` int(11) NOT NULL,
  `minuto` int(3) DEFAULT '0',
  PRIMARY KEY (`idcambio`),
  KEY `fk_cambios_fixture_idx` (`reffixture`),
  KEY `fk_cambios_equipos_idx` (`refequipos`),
  KEY `fk_cambios_categorias_idx` (`refcategorias`),
  KEY `fk_cambios_divisiones_idx` (`refdivisiones`)
...
CREATE TABLE IF NOT EXISTS `dbcanchasuspenciones` (
  ...
  KEY `fk_suspenciones_canchas_idx` (`refcanchas`)
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=57327 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=1239 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=632 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=365 ;
...
CREATE TABLE IF NOT EXISTS `dbcountries` (
  ...
  `localidad` varchar(110) COLLATE utf8_spanish_ci DEFAULT NULL,
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=115 ;
...
--
-- Estructura de tabla para la tabla `dbdorsales`
--

CREATE TABLE IF NOT EXISTS `dbdorsales` (
  `iddorsal` int(11) NOT NULL AUTO_INCREMENT,
  `refjugadores` int(11) NOT NULL,
  `reffixture` int(11) NOT NULL,
  `refequipos` int(11) NOT NULL,
  `refcategorias` int(11) NOT NULL,
  ...
  PRIMARY KEY (`iddorsal`),
  KEY `fk_dorsales_jugadores_idx` (`refjugadores`),
  KEY `fk_dorsales_fixture_idx` (`reffixture`),
  KEY `fk_dorsales_equipos_idx` (`refequipos`),
  KEY `fk_dorsales_categorias_idx` (`refcategorias`),
  KEY `fk_dorsales_divisiones_idx` (`refdivisiones`)
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=755 ;
...
CREATE TABLE IF NOT EXISTS `dbfixture` (
  ...
  `refconectorlocal` int(11) DEFAULT NULL,
  `refconectorvisitante` int(11) DEFAULT NULL,
  `refarbitros` int(11) DEFAULT NULL,
  ...
  `refestadospartidos` int(11) DEFAULT NULL,
  ...
  `refetapas` int(11) DEFAULT NULL,
  `posicion` int(11) DEFAULT NULL,
  PRIMARY KEY (`idfixture`),
  KEY `fk_fixture_torneos_idx` (`reftorneos`),
  KEY `fk_fixture_fechas_idx` (`reffechas`),
  KEY `fk_fixture_conectorA_idx` (`refconectorlocal`),
  KEY `fk_fixture_arbitros_idx` (`refarbitros`),
  KEY `fk_fixture_cancha_idx` (`refcanchas`),
  KEY `fk_fixture_estadopartidos_idx` (`refestadospartidos`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=9484 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=74624 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=17772 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=450816 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=9105 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=130631 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=323423 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=8365 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=11970 ;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dbsancionesfallosacumuladas`
--

CREATE TABLE IF NOT EXISTS `dbsancionesfallosacumuladas` (
  `idsancionfalloacumuladas` int(11) NOT NULL AUTO_INCREMENT,
  `refsancionesjugadores` int(11) NOT NULL,
  `cantidadfechas` int(11) NOT NULL,
  `fechadesde` date DEFAULT NULL,
  `fechahasta` date DEFAULT NULL,
  ...
  `generadaporacumulacion` bit(1) DEFAULT NULL,
  `observaciones` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`idsancionfalloacumuladas`)
...
CREATE TABLE IF NOT EXISTS `dbsancionesfechascumplidas` (
  ...
  `refsancionesfallosacumuladas` int(11) DEFAULT NULL,
  PRIMARY KEY (`idsancionfechacumplida`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=16437 ;
...
CREATE TABLE IF NOT EXISTS `dbsancionesjugadores` (
  ...
  `refcategorias` int(11) NOT NULL,
  `refdivisiones` int(11) DEFAULT NULL,
  `refsancionesfallos` int(11) DEFAULT NULL,
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=65780 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=512524 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=248 ;
...
CREATE TABLE IF NOT EXISTS `tbvaloreshabilitacionestransitorias` (
  ...
  `valorviejo` int(11) DEFAULT NULL,
  PRIMARY KEY (`idvalorhabilitaciontransitoria`),
  KEY `fk_valores_motivos_idx` (`refdocumentaciones`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=210 ;
...
--
-- Filtros para la tabla `dbcambios`
--
ALTER TABLE `dbcambios`
  ADD CONSTRAINT `fk_cambios_categorias` FOREIGN KEY (`refcategorias`) REFERENCES `tbcategorias` (`idtcategoria`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_cambios_divisiones` FOREIGN KEY (`refdivisiones`) REFERENCES `tbdivisiones` (`iddivision`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_cambios_equipos` FOREIGN KEY (`refequipos`) REFERENCES `dbequipos` (`idequipo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_cambios_fixture` FOREIGN KEY (`reffixture`) REFERENCES `dbfixture` (`idfixture`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `dbcanchasuspenciones`
--
ALTER TABLE `dbcanchasuspenciones`
  ADD CONSTRAINT `fk_suspenciones_canchas` FOREIGN KEY (`refcanchas`) REFERENCES `tbcanchas` (`idcancha`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Filtros para la tabla `dbdorsales`
--
ALTER TABLE `dbdorsales`
  ADD CONSTRAINT `fk_dorsales_categorias` FOREIGN KEY (`refcategorias`) REFERENCES `tbcategorias` (`idtcategoria`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_dorsales_divisiones` FOREIGN KEY (`refdivisiones`) REFERENCES `tbdivisiones` (`iddivision`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_dorsales_equipos` FOREIGN KEY (`refequipos`) REFERENCES `dbequipos` (`idequipo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_dorsales_fixture` FOREIGN KEY (`reffixture`) REFERENCES `dbfixture` (`idfixture`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_dorsales_jugadores` FOREIGN KEY (`refjugadores`) REFERENCES `dbjugadores` (`idjugador`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `tbvaloreshabilitacionestransitorias`
  ...
  ADD CONSTRAINT `fk_valores_motivos` FOREIGN KEY (`refdocumentaciones`) REFERENCES `tbmotivoshabilitacionestransitorias` (`idmotivoshabilitacionestransitoria`) ON DELETE NO ACTION ON UPDATE NO ACTION;
