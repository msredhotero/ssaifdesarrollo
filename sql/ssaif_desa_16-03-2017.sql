...
--
-- Servidor: localhost
-- Tiempo de generación: 16-03-2017 a las 14:38:30
...
--
-- Volcado de datos para la tabla `dbconector`
--

INSERT INTO `dbconector` (`idconector`, `refjugadores`, `reftipojugadores`, `refequipos`, `refcountries`, `refcategorias`, `esfusion`, `activo`) VALUES
(1, 1, 2, 1, 2, 1, b'0', b'0'),
(3, 1, 1, 1, 2, 2, b'0', b'1'),
(4, 5, 1, 2, 2, 2, b'0', b'1'),
(5, 4, 1, 2, 2, 2, b'0', b'1'),
...
(7, 7, 1, 2, 2, 2, b'0', b'1'),
(8, 2, 1, 2, 2, 2, b'1', b'0'),
(10, 2, 1, 10, 6, 1, b'0', b'1'),
(14, 2, 1, 8, 6, 2, b'0', b'0'),
(15, 2, 1, 2, 2, 2, b'1', b'1'),
(16, 8, 1, 1, 2, 1, b'0', b'1'),
(17, 9, 1, 3, 2, 1, b'0', b'1'),
(18, 10, 1, 1, 2, 1, b'0', b'1'),
(19, 11, 1, 6, 2, 1, b'0', b'1'),
(20, 12, 1, 4, 2, 1, b'0', b'1'),
(21, 13, 1, 5, 2, 1, b'0', b'1'),
(22, 14, 1, 7, 2, 1, b'0', b'1');
...
(7, 1, 'asfewf', 'wefwef', '', '', '', '', '', '', '', b'0'),
(8, 1, 'asfewf', 'wefwef', '', '', '', '', '', '', '', b'0'),
(9, 1, 'fgqergerg', '', '', '', '', '', '', '', '', b'0'),
(10, 1, 'asdasdasd', '', '', '', '', '', '', '', '', b'0'),
(11, 2, 'Salazar Luciana', '', 'La plata', '', '', '', '', '', '', b'0'),
(15, 1, 'alice', '', '', '', '', '', '', '', '', b'0'),
(17, 2, 'stanley', '', '', '', '', '', '', '', '', b'0'),
(18, 1, 'drogs', '', '', '', '', '', '', '', '', b'0'),
(19, 2, 'jeff', '', '', '', '', '', '', '', '', b'0'),
...
INSERT INTO `dbcountries` (`idcountrie`, `nombre`, `cuit`, `fechaalta`, `fechabaja`, `refposiciontributaria`, `latitud`, `longitud`, `activo`, `referencia`, `imagen`, `direccion`, `telefonoadministrativo`, `telefonocampo`, `email`, `localidad`, `codigopostal`) VALUES
(1, 'Los alpes', '30-20654789', '2000-10-10', NULL, 1, '-34.61936482473979', '-58.61048699123785', b'0', 'Javier', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'Banco Provincia', '32164849', '2016-11-10', NULL, 1, '-34.57423163738421', '-58.437406537123024', b'1', 'Juliana', '', NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'Daniela', '651684984', '2016-11-12', NULL, 1, '-34.578712136211195', '-58.401309011969715', b'1', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'Tito Tomatino', '30-123654-3', '1975-07-04', NULL, 1, '-34.49995019905041', '-58.48578929202631', b'1', 'Sebastian', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, 'prueba', '354165468', '0000-00-00', NULL, 1, '', '', b'1', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 'juan andres', '234234234', '1994-04-04', NULL, 1, '', '', b'1', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 'errrrrrrr', '1234321234', '2017-02-03', NULL, 1, '', '', b'1', '', '', '', '', '', NULL, NULL, NULL),
(8, 'kramer', '532165498', '2017-02-08', NULL, 1, '', '', b'1', '', '', '', '', '', '', '', '');
...
--
-- Volcado de datos para la tabla `dbdefinicionescategoriastemporadas`
--

INSERT INTO `dbdefinicionescategoriastemporadas` (`iddefinicioncategoriatemporada`, `refcategorias`, `reftemporadas`, `cantmaxjugadores`, `cantminjugadores`, `refdias`, `hora`, `minutospartido`, `cantidadcambiosporpartido`, `conreingreso`, `observaciones`) VALUES
(1, 1, 1, 50, 1, 1, '15:30', 80, 99, b'0', ''),
(2, 2, 1, 50, 1, 2, '16:00', 80, 99, b'1', '');
...
--
-- Volcado de datos para la tabla `dbdefinicionescategoriastemporadastipojugador`
--

INSERT INTO `dbdefinicionescategoriastemporadastipojugador` (`iddefinicionescategoriastemporadastipojugador`, `refdefinicionescategoriastemporadas`, `reftipojugadores`, `edadmaxima`, `edadminima`, `cantjugadoresporequipo`, `jugadorescancha`, `observaciones`) VALUES
(1, 1, 1, 19, 1, 1, 1, ''),
(2, 1, 2, 19, 1, 28, 7, ''),
(3, 2, 2, 50, 19, 40, 7, ''),
(4, 2, 1, 58, 18, 45, 7, '');
...
--
-- Volcado de datos para la tabla `dbdefinicionessancionesacumuladastemporadas`
--

INSERT INTO `dbdefinicionessancionesacumuladastemporadas` (`iddefinicionessancionesacumuladastemporadas`, `reftiposanciones`, `reftemporadas`, `cantidadacumulada`, `cantidadfechasacumplir`) VALUES
(1, 1, 1, 5, 1);
...
INSERT INTO `dbequipos` (`idequipo`, `refcountries`, `nombre`, `refcategorias`, `refdivisiones`, `refcontactos`, `fechaalta`, `fachebaja`, `activo`) VALUES
(1, 2, 'Banco Provincia "B"', 1, 1, 2, '2016-12-20', '0000-00-00', b'1'),
(2, 2, 'Banco C', 2, 1, 2, '0000-00-00', '0000-00-00', b'1'),
(3, 2, 'Pelelos', 1, 1, 11, '0000-00-00', '0000-00-00', b'1'),
(4, 2, 'Cabezon', 1, 1, 2, '0000-00-00', '0000-00-00', b'1'),
(5, 2, 'Roja Directa', 1, 1, 2, '0000-00-00', '0000-00-00', b'1'),
(6, 2, 'Menos No', 1, 1, 2, '0000-00-00', '0000-00-00', b'1'),
(7, 2, 'Rambo', 1, 1, 2, '0000-00-00', '0000-00-00', b'1'),
(8, 6, 'Andresito', 2, 1, 21, '0000-00-00', '0000-00-00', b'1'),
(9, 6, 'Mini Andresitos', 1, 1, 21, '0000-00-00', '0000-00-00', b'1'),
(10, 6, 'Mini andresitos II', 1, 1, 21, '0000-00-00', '0000-00-00', b'1');
...
INSERT INTO `dbfixture` (`idfixture`, `reftorneos`, `reffechas`, `refconectorlocal`, `refconectorvisitante`, `refarbitros`, `juez1`, `juez2`, `refcanchas`, `fecha`, `hora`, `refestadospartidos`, `calificacioncancha`, `puntoslocal`, `puntosvisita`, `goleslocal`, `golesvisitantes`, `observaciones`, `publicar`) VALUES
(3, 1, 1, 1, 3, NULL, '', '', NULL, '2017-02-20 00:00:00', '15:30:00', 2, NULL, 0, 3, 0, 1, '', b'1'),
(4, 1, 1, 6, 4, NULL, '', '', NULL, '2017-02-20 00:00:00', '15:30:00', 1, NULL, 3, 0, 3, 0, '', b'1'),
(5, 1, 1, 5, 7, NULL, '', '', NULL, '2017-02-20 00:00:00', '15:30:00', 5, NULL, 3, 0, 2, 0, '', b'1'),
(6, 1, 2, 4, 1, NULL, '', '', NULL, '2017-02-27 00:00:00', '15:30:00', NULL, NULL, NULL, NULL, NULL, NULL, '', b'0'),
(7, 1, 2, 5, 6, NULL, '', '', NULL, '2017-02-27 00:00:00', '15:30:00', NULL, NULL, NULL, NULL, NULL, NULL, '', b'0'),
(8, 1, 2, 7, 3, NULL, '', '', NULL, '2017-02-27 00:00:00', '15:30:00', NULL, NULL, NULL, NULL, NULL, NULL, '', b'0'),
(9, 1, 3, 1, 5, NULL, '', '', NULL, '2017-03-06 00:00:00', '15:30:00', NULL, NULL, NULL, NULL, NULL, NULL, '', b'0'),
(10, 1, 3, 3, 4, NULL, '', '', 13, '2017-03-06 00:00:00', '15:30:00', 2, NULL, 0, 3, 0, 1, '', b'1'),
(11, 1, 3, 6, 7, NULL, '', '', NULL, '2017-03-06 00:00:00', '15:30:00', NULL, NULL, NULL, NULL, NULL, NULL, '', b'0'),
(12, 1, 4, 6, 1, NULL, '', '', NULL, '2017-03-13 00:00:00', '15:30:00', NULL, NULL, NULL, NULL, NULL, NULL, '', b'0'),
(13, 1, 4, 5, 3, NULL, '', '', NULL, '2017-03-13 00:00:00', '15:30:00', NULL, NULL, NULL, NULL, NULL, NULL, '', b'0'),
(14, 1, 4, 7, 4, NULL, '', '', NULL, '2017-03-13 00:00:00', '15:30:00', NULL, NULL, NULL, NULL, NULL, NULL, '', b'0'),
(15, 1, 5, 4, 5, NULL, '', '', NULL, '2017-03-20 00:00:00', '15:30:00', NULL, NULL, NULL, NULL, NULL, NULL, '', b'0'),
(16, 1, 5, 3, 6, NULL, '', '', NULL, '2017-03-20 00:00:00', '15:30:00', NULL, NULL, NULL, NULL, NULL, NULL, '', b'0'),
(17, 1, 5, 1, 7, NULL, '', '', NULL, '2017-03-20 00:00:00', '15:30:00', NULL, NULL, NULL, NULL, NULL, NULL, '', b'0');
...
--
-- Volcado de datos para la tabla `dbgoleadores`
--

INSERT INTO `dbgoleadores` (`idgoleador`, `refjugadores`, `reffixture`, `refequipos`, `refcategorias`, `refdivisiones`, `goles`, `encontra`) VALUES
(13, 8, 3, 1, 1, 1, 0, 0),
(14, 10, 3, 1, 1, 1, 0, 0),
(15, 9, 3, 3, 1, 1, 1, 0),
(16, 11, 4, 6, 1, 1, 3, 0),
...
INSERT INTO `dbjugadores` (`idjugador`, `reftipodocumentos`, `nrodocumento`, `apellido`, `nombres`, `email`, `fechanacimiento`, `fechaalta`, `fechabaja`, `refcountries`, `observaciones`) VALUES
(1, 1, 31552466, 'Safar', 'Marcos Daniel', 'msredhotero@msn.com', '2000-05-20', '2016-12-28', '0000-00-00', 2, ''),
(2, 1, 30555666, 'AIF', 'Sebastian', '', '1989-07-14', '2017-01-05', '0000-00-00', 6, ''),
(3, 1, 12478563, 'dasdasd', 'sadfsdf', '', '1981-05-20', '2017-01-24', '0000-00-00', 2, ''),
(4, 1, 12, 'Ortega', 'martin', '', '1985-05-20', '2017-02-08', '0000-00-00', 2, ''),
(5, 1, 13, 'Perez', 'Damian', '', '1986-02-21', '2017-02-08', '0000-00-00', 2, ''),
(6, 1, 4111111, 'Queves', 'Tal', '', '1982-05-22', '2017-02-08', '0000-00-00', 2, ''),
(7, 1, 9588, 'Cielo', 'Razzo', '', '1979-01-01', '2017-02-08', '0000-00-00', 2, ''),
(8, 1, 432111111, 'Moyano', 'Juan', '', '2005-11-11', '2017-02-21', '0000-00-00', 2, ''),
(9, 1, 7412566, 'Moon', 'Light', '', '2006-12-19', '2017-02-21', '0000-00-00', 2, ''),
(10, 1, 8434234, 'Gino', 'Gigi', '', '2003-09-29', '2017-02-21', '0000-00-00', 2, ''),
(11, 1, 3344, 'Mer', 'pi', '', '2005-05-20', '2017-02-28', '0000-00-00', 2, ''),
(12, 1, 11234, 'Qwe', 'reew', '', '2003-10-15', '2017-02-28', '0000-00-00', 2, ''),
(13, 1, 4432, 'ccd', 'dcc', '', '2001-01-01', '2017-02-28', '0000-00-00', 2, ''),
(14, 1, 54112, 'Zae', 'QAs', '', '2009-09-09', '2017-02-28', '0000-00-00', 2, '');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=218 ;

--
-- Volcado de datos para la tabla `dbjugadoresdocumentacion`
--

INSERT INTO `dbjugadoresdocumentacion` (`idjugadordocumentacion`, `refjugadores`, `refdocumentaciones`, `valor`, `observaciones`) VALUES
(113, 1, 1, b'1', ''),
(114, 1, 4, b'1', ''),
(115, 1, 5, b'0', ''),
(116, 1, 6, b'1', ''),
...
--
-- Volcado de datos para la tabla `dbjugadoresmotivoshabilitacionestransitorias`
--

INSERT INTO `dbjugadoresmotivoshabilitacionestransitorias` (`iddbjugadormotivohabilitaciontransitoria`, `reftemporadas`, `refjugadores`, `refdocumentaciones`, `refmotivoshabilitacionestransitorias`, `refequipos`, `refcategorias`, `fechalimite`, `observaciones`) VALUES
(2, 1, 1, 6, 4, 1, 1, '0000-00-00', ''),
(6, 1, 1, 1, 3, 1, 1, '2017-12-31', ''),
(7, 1, 2, 1, 3, 10, 1, '2017-12-31', '');
...
--
-- Volcado de datos para la tabla `dbjugadoresvaloreshabilitacionestransitorias`
--

INSERT INTO `dbjugadoresvaloreshabilitacionestransitorias` (`iddbjugadorvalorhabilitaciontransitoria`, `refjugadores`, `refvaloreshabilitacionestransitorias`) VALUES
(23, 1, 6),
(24, 1, 9),
(25, 4, 7),
(26, 4, 11),
...
--
-- Volcado de datos para la tabla `dbminutosjugados`
--

INSERT INTO `dbminutosjugados` (`idminutojugado`, `refjugadores`, `reffixture`, `refequipos`, `refcategorias`, `refdivisiones`, `minutos`) VALUES
(16, 8, 3, 1, 1, 1, 5),
(17, 10, 3, 1, 1, 1, 45),
(18, 9, 3, 3, 1, 1, 15),
(19, 11, 4, 6, 1, 1, 80),
...
--
-- Estructura de tabla para la tabla `dbmovimientosanciones`
--

CREATE TABLE IF NOT EXISTS `dbmovimientosanciones` (
  `idmovimientosancion` int(11) NOT NULL AUTO_INCREMENT,
  `refsancionesjugadores` int(11) NOT NULL,
  `reffechas` int(11) NOT NULL,
  `reffixture` int(11) NOT NULL,
  `cumplidas` int(11) DEFAULT NULL,
  `finalizo` bit(1) DEFAULT NULL,
  PRIMARY KEY (`idmovimientosancion`),
  KEY `fk_mov_sancionjugador_idx` (`refsancionesjugadores`),
  KEY `fk_mov_fechas_idx` (`reffechas`),
  KEY `fk_mov_fixture_idx` (`reffixture`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=11 ;

--
-- Volcado de datos para la tabla `dbmovimientosanciones`
--

INSERT INTO `dbmovimientosanciones` (`idmovimientosancion`, `refsancionesjugadores`, `reffechas`, `reffixture`, `cumplidas`, `finalizo`) VALUES
(6, 13, 2, 3, 0, b'0'),
(7, 13, 3, 3, 0, b'0'),
(8, 13, 4, 3, 0, b'0'),
(9, 13, 5, 3, 0, b'0'),
...
--
-- Estructura de tabla para la tabla `dbpartidojugadorsuspendido`
--

CREATE TABLE IF NOT EXISTS `dbpartidojugadorsuspendido` (
  `idpartidojugadorsuspendido` int(11) NOT NULL AUTO_INCREMENT,
  `reffixture` int(11) NOT NULL,
  `refjugadores` int(11) NOT NULL,
  `refsancionesjugadores` int(11) NOT NULL,
  PRIMARY KEY (`idpartidojugadorsuspendido`),
  KEY `fk_pjs_fixture_idx` (`reffixture`),
  KEY `fk_pjs_jugadores_idx` (`refjugadores`),
  KEY `fk_pjs_sancion_idx` (`refsancionesjugadores`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=1 ;
...
--
-- Estructura de tabla para la tabla `dbsancionesbajas`
--

CREATE TABLE IF NOT EXISTS `dbsancionesbajas` (
  `idsancionesbaja` int(11) NOT NULL AUTO_INCREMENT,
  `refsancionesfallos` int(11) NOT NULL,
  `fechabaja` date NOT NULL,
  `usuacrea` varchar(80) COLLATE utf8_spanish_ci DEFAULT NULL,
  `motivos` varchar(150) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`idsancionesbaja`),
  KEY `fk_baja_fallos_idx` (`refsancionesfallos`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=1 ;
...
--
-- Volcado de datos para la tabla `dbsancionesfallos`
--
...
(2, 13, 5, '0000-00-00', '0000-00-00', 0, 0, b'0', b'0', b'0', '                        \r\n                   '),
(3, 7, 0, '0000-00-00', '0000-00-00', 2, 0, b'0', b'0', b'0', '                        \r\n                   ');
...
--
-- Volcado de datos para la tabla `dbsancionesjugadores`
--

INSERT INTO `dbsancionesjugadores` (`idsancionjugador`, `reftiposanciones`, `refjugadores`, `refequipos`, `reffixture`, `fecha`, `cantidad`, `refcategorias`, `refdivisiones`, `refsancionesfallos`) VALUES
(1, 1, 10, 1, 3, '2017-02-20', 1, 1, 1, NULL),
(2, 2, 10, 1, 3, '2017-02-20', 0, 1, 1, NULL),
(3, 3, 10, 1, 3, '2017-02-20', 0, 1, 1, NULL),
(4, 4, 10, 1, 3, '2017-02-20', 0, 1, 1, NULL),
(5, 5, 10, 1, 3, '2017-02-20', 0, 1, 1, NULL),
(6, 1, 8, 1, 3, '2017-02-20', 0, 1, 1, NULL),
(7, 2, 8, 1, 3, '2017-02-20', 1, 1, 1, 3),
(8, 3, 8, 1, 3, '2017-02-20', 0, 1, 1, NULL),
(9, 4, 8, 1, 3, '2017-02-20', 0, 1, 1, NULL),
(10, 5, 8, 1, 3, '2017-02-20', 0, 1, 1, NULL),
(11, 1, 9, 3, 3, '2017-02-20', 0, 1, 1, NULL),
(12, 2, 9, 3, 3, '2017-02-20', 0, 1, 1, NULL),
(13, 3, 9, 3, 3, '2017-02-20', 1, 1, 1, 2),
(14, 4, 9, 3, 3, '2017-02-20', 0, 1, 1, NULL),
(15, 5, 9, 3, 3, '2017-02-20', 0, 1, 1, NULL),
(16, 1, 12, 4, 10, '2017-03-06', 0, 1, 1, NULL),
(17, 2, 12, 4, 10, '2017-03-06', 0, 1, 1, NULL),
(18, 3, 12, 4, 10, '2017-03-06', 0, 1, 1, NULL),
(19, 4, 12, 4, 10, '2017-03-06', 0, 1, 1, NULL),
(20, 5, 12, 4, 10, '2017-03-06', 0, 1, 1, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dbtorneopuntobonus`
--

CREATE TABLE IF NOT EXISTS `dbtorneopuntobonus` (
  `idtorneopuntobonus` int(11) NOT NULL AUTO_INCREMENT,
  `reftorneos` int(11) NOT NULL,
  `refpuntobonus` int(11) NOT NULL,
  PRIMARY KEY (`idtorneopuntobonus`),
  KEY `fk_torneopuntobonus_torneo_idx` (`reftorneos`),
  KEY `fk_torneopuntobonus_puntobonus_idx` (`refpuntobonus`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=1 ;
...
INSERT INTO `dbtorneos` (`idtorneo`, `descripcion`, `reftipotorneo`, `reftemporadas`, `refcategorias`, `refdivisiones`, `cantidadascensos`, `cantidaddescensos`, `respetadefiniciontipojugadores`, `respetadefinicionhabilitacionestransitorias`, `respetadefinicionsancionesacumuladas`, `acumulagoleadores`, `acumulatablaconformada`, `observaciones`, `activo`) VALUES
(1, 'Clausura', 2, 1, 1, 1, 1, 1, b'1', b'1', b'1', b'1', b'1', '', b'1'),
(2, 'Apertura', 1, 1, 1, 1, 0, 0, b'1', b'1', b'1', b'1', b'1', '', b'1');
...
(32, '../valoreshabilitacionestransitorias/', 'icozonas', 'Valores Documentaciones', 14, NULL, 'Administrador', b'1', b'1', b'1'),
(33, '../puntosbonus/', 'icozonas', 'Punto Bonus', 15, NULL, 'Administrador', b'1', b'1', b'1'),
(34, '../tipossanciones/', 'icozonas', 'Tipos Sanciones', 16, NULL, 'Administrador', b'1', b'1', b'1'),
(35, '../fechasexcluidas/', 'icozonas', 'Fechas Excluidas', 17, NULL, 'Administrador', b'1', b'1', b'1'),
(36, '../estadospartidos/', 'icozonas', 'Estados Partidos', 18, NULL, 'Administrador', b'1', b'1', b'1'),
(37, '../torneos/', 'icozonas', 'Torneos', 19, NULL, 'Administrador', b'1', b'1', b'1'),
(38, '../equipos/', 'icozonas', 'Equipos', 20, NULL, 'Administrador', b'1', b'1', b'1'),
(39, '../definicionescategoriastemporadas/', 'icozonas', 'Def.Cat.Temp.', 21, NULL, 'Administrador', b'1', b'1', b'1'),
(40, '../definicionescategoriastemporadastipojugadores/', 'icozonas', 'Def.Cat.Temp.Tipo Jugador', 22, NULL, 'Administrador', b'1', b'1', b'1'),
(41, '../definicionessancionesacumuladastemporadas/', 'icozonas', 'Def.Sanc.Acum.Temp.', 23, NULL, 'Administrador', b'1', b'1', b'1'),
(42, '../reportes/', 'icozonas', 'Reportes', 24, NULL, 'Administrador', b'1', b'1', b'1'),
(43, '../fixture/', 'icozonas', 'Fixture', 10, NULL, 'Administrador', b'1', b'1', b'1'),
(44, '../estadisticas/', 'icozonas', 'Estadisticas', 9, NULL, 'Administrador', b'1', b'1', b'1'),
(45, '../prefallos/', 'icozonas', 'Pre-Fallos', 12, NULL, 'Administrador', b'1', b'1', b'1'),
(46, '../fallos/', 'icozonas', 'Fallos', 13, NULL, 'Administrador', b'1', b'1', b'1');
...
CREATE TABLE IF NOT EXISTS `tbestadospartidos` (
  ...
  `contabilizalocal` varchar(1) DEFAULT NULL,
  `contabilizavisitante` varchar(1) DEFAULT NULL,
  PRIMARY KEY (`idestadopartido`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=26 ;

--
-- Volcado de datos para la tabla `tbestadospartidos`
--

INSERT INTO `tbestadospartidos` (`idestadopartido`, `descripcion`, `defautomatica`, `goleslocalauto`, `goleslocalborra`, `golesvisitanteauto`, `golesvisitanteborra`, `puntoslocal`, `puntosvisitante`, `finalizado`, `ocultardetallepublico`, `visibleparaarbitros`, `contabilizalocal`, `contabilizavisitante`) VALUES
(1, 'Gana Local', b'0', 0, b'0', 0, b'0', 3, 0, b'1', b'0', b'0', 'G', 'P'),
(2, 'Gana Visitante', b'0', 0, b'0', 0, b'0', 0, 3, b'1', b'0', b'0', 'P', 'G'),
(3, 'Empate', b'0', 0, b'0', 0, b'0', 1, 1, b'1', b'0', b'0', 'E', 'E'),
(4, 'W.O. Local', b'1', 0, b'1', 2, b'0', 0, 3, b'1', b'0', b'0', 'P', 'G'),
(5, 'W.O. Visitante', b'1', 2, b'0', 0, b'1', 3, 0, b'1', b'0', b'0', 'G', 'P'),
(6, 'Inf. Num. Local', b'1', 0, b'1', 2, b'0', 0, 3, b'1', b'0', b'0', 'P', 'G'),
(7, 'Inf. Num. Visitante', b'1', 2, b'0', 0, b'1', 3, 0, b'1', b'0', b'0', 'G', 'P'),
(8, 'Suspendido', b'0', 0, b'0', 0, b'0', 0, 0, b'0', b'0', b'0', '', ''),
(9, 'Pendiente de Resolucion', b'0', 0, b'1', 0, b'1', 0, 0, b'0', b'0', b'0', '', ''),
(10, 'W.O. Ambos', b'1', 0, b'1', 0, b'1', 0, 0, b'1', b'0', b'0', 'P', 'P'),
(11, 'Perdida de puntos a ambos por res. CD y TD', b'1', 0, b'1', 0, b'1', 0, 0, b'1', b'0', b'0', 'P', 'P'),
(12, 'GANA LOCAL ARBITRO', b'0', 0, b'0', 0, b'0', 3, 0, b'0', b'1', b'1', '', ''),
(13, 'GANA VISITANTE ARBITRO', b'0', 0, b'0', 0, b'0', 0, 3, b'0', b'1', b'1', '', ''),
(14, 'EMPATE ARBITRO', b'0', 0, b'0', 0, b'0', 1, 1, b'0', b'1', b'1', '', ''),
(15, 'SUSPENDIDO ARBITRO', b'0', 0, b'0', 0, b'0', 0, 0, b'0', b'1', b'1', '', ''),
(17, 'NO SE DISPUTA', b'0', 0, b'0', 0, b'0', 0, 0, b'0', b'1', b'0', '', ''),
(18, 'NO JUGADO AUSENCIA ARBITRO', b'0', 0, b'0', 0, b'0', 0, 0, b'0', b'1', b'1', '', ''),
(19, 'Perdida de puntos local por res. CD y TD', b'1', 0, b'1', 2, b'0', 0, 3, b'1', b'0', b'0', 'P', 'G'),
(20, 'Perdida de puntos visitante por res. CD y TD', b'1', 2, b'0', 0, b'1', 3, 0, b'1', b'0', b'0', 'G', 'P'),
(21, 'NO JUGADO MAL ESTADO CAMPO DE JUEGO', b'0', 0, b'0', 0, b'0', 0, 0, b'0', b'1', b'1', '', ''),
(22, 'SUSPENDIDO ARBITRO L', b'0', 0, b'0', 0, b'0', 3, 0, b'0', b'1', b'1', '', ''),
(23, 'SUSPENDIDO ARBITRO V', b'0', 0, b'0', 0, b'0', 0, 3, b'0', b'1', b'1', '', ''),
(24, 'Suspendido Finalizado', b'1', 0, b'1', 0, b'1', 0, 0, b'1', b'0', b'0', 'P', 'P'),
(25, 'Perdida de puntos a ambos por res. CD', b'1', 0, b'1', 0, b'1', 0, 0, b'1', b'0', b'0', 'P', 'P');
...
INSERT INTO `tbfechas` (`idfecha`, `fecha`) VALUES
(1, 'Fecha 1'),
(2, 'Fecha 2'),
(3, 'Fecha 3'),
(4, 'Fecha 4'),
...
--
-- Volcado de datos para la tabla `tbfechasexcluidas`
--

INSERT INTO `tbfechasexcluidas` (`idfechaexcluida`, `fecha`, `descripcion`) VALUES
(1, '2017-01-01', 'Año Nuevo 2017'),
(2, '1985-05-20', 'marcos cumpleaños');
...
INSERT INTO `tbmotivoshabilitacionestransitorias` (`idmotivoshabilitacionestransitoria`, `inhabilita`, `descripcion`, `refdocumentaciones`) VALUES
(1, b'0', 'Foto', 4),
(2, b'0', 'Ficha', 5),
(3, b'1', 'Edad', 1),
(4, b'0', 'Titulo', 6);
...
--
-- Volcado de datos para la tabla `tbpuntobonus`
--

INSERT INTO `tbpuntobonus` (`idpuntobonus`, `descripcion`, `cantidadfechas`, `comparacion`, `valoracomparar`, `puntosextra`, `consecutivas`) VALUES
(1, 'Puntos Bonus', 4, '=', 0, 1, b'1');
...
--
-- Volcado de datos para la tabla `tbtiposanciones`
--

INSERT INTO `tbtiposanciones` (`idtiposancion`, `descripcion`, `cantminfechas`, `cantmaxfechas`, `abreviatura`, `expulsion`, `amonestacion`, `cumpletodascategorias`, `llevapendiente`, `ocultardetallepublico`) VALUES
(1, 'AMONESTACION', 0, 99, 'A', b'0', b'1', b'0', b'0', b'0'),
(2, 'EXPULSADO', 1, 200, 'E', b'1', b'0', b'1', b'1', b'0'),
(3, 'INFORMADO', 1, 200, 'I', b'1', b'0', b'1', b'1', b'0'),
(4, 'DOBLE AMONESTACION', 0, 200, 'A+A', b'1', b'0', b'0', b'1', b'0'),
(5, 'POR CD Y TD', 1, 99, 'CDTD', b'1', b'0', b'1', b'1', b'1');
...
INSERT INTO `tbvaloreshabilitacionestransitorias` (`idvalorhabilitaciontransitoria`, `refdocumentaciones`, `descripcion`, `habilita`, `predeterminado`) VALUES
(5, 5, 'H - Si titulo, Si Dominio', b'1', b'0'),
(6, 5, 'I - No Titulo, No Dominio', b'0', b'0'),
(7, 5, 'I - Si Titulo, No Dominio', b'0', b'1'),
(8, 9, 'variable 4', b'1', b'1'),
(9, 9, 'variable 6', b'0', b'0'),
(10, 9, 'variable9', b'0', b'0'),
(11, 8, 'marcos', b'1', b'0');
...
--
-- Filtros para la tabla `dbmovimientosanciones`
--
ALTER TABLE `dbmovimientosanciones`
  ADD CONSTRAINT `fk_mov_fechas` FOREIGN KEY (`reffechas`) REFERENCES `tbfechas` (`idfecha`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_mov_fixture` FOREIGN KEY (`reffixture`) REFERENCES `dbfixture` (`idfixture`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_mov_sancionjugador` FOREIGN KEY (`refsancionesjugadores`) REFERENCES `dbsancionesjugadores` (`idsancionjugador`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `dbpartidojugadorsuspendido`
--
ALTER TABLE `dbpartidojugadorsuspendido`
  ADD CONSTRAINT `fk_pjs_fixture` FOREIGN KEY (`reffixture`) REFERENCES `dbfixture` (`idfixture`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_pjs_jugadores` FOREIGN KEY (`refjugadores`) REFERENCES `dbjugadores` (`idjugador`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_pjs_sancion` FOREIGN KEY (`refsancionesjugadores`) REFERENCES `dbsancionesjugadores` (`idsancionjugador`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Filtros para la tabla `dbsancionesbajas`
--
ALTER TABLE `dbsancionesbajas`
  ADD CONSTRAINT `fk_baja_fallos` FOREIGN KEY (`refsancionesfallos`) REFERENCES `dbsancionesfallos` (`idsancionfallo`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Filtros para la tabla `dbtorneopuntobonus`
--
ALTER TABLE `dbtorneopuntobonus`
  ADD CONSTRAINT `fk_torneopuntobonus_puntobonus` FOREIGN KEY (`refpuntobonus`) REFERENCES `tbpuntobonus` (`idpuntobonus`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_torneopuntobonus_torneo` FOREIGN KEY (`reftorneos`) REFERENCES `dbtorneos` (`idtorneo`) ON DELETE NO ACTION ON UPDATE NO ACTION;
