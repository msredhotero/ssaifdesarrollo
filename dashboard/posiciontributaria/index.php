...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../posiciontributaria/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Posicion Tributaria",$_SESSION['refroll_predio'],$_SESSION['email_predio']);
...
$insertar = "insertarPosiciontributaria";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerPosiciontributaria(),2);
