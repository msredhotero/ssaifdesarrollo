...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../tipocontacto/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Tipo Contacto",$_SESSION['refroll_predio'],$_SESSION['email_predio']);
