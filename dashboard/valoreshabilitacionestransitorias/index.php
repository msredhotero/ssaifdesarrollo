...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../valoreshabilitacionestransitorias/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Valores Documentaciones",$_SESSION['refroll_predio'],$_SESSION['email_predio']);
...
$insertar = "insertarValoreshabilitacionestransitorias";
