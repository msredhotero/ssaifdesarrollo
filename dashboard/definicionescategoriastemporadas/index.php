...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../definicionescategoriastemporadas/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Def.Cat.Temp.",$_SESSION['refroll_predio'],$_SESSION['email_predio']);
...
$insertar = "insertarDefinicionescategoriastemporadas";
...
$lblCambio	 	= array("refcategorias","reftemporadas","cantmaxjugadores","cantminjugadores","minutospartido","cantidadcambiosporpartido","conreingreso","refdias","cambiosilimitados");
$lblreemplazo	= array("Categoria","Temporadas","Cant.Max. Jugadores","Cant.Min. Jugadores","Minutos Partidos","Cant.Cambios X Partidos","Con Reingresos","Días","Cambios Ilimitados");
...
$refCampo 	=  array("refcategorias","reftemporadas","refdias","cambiosilimitados");
//////////////////////////////////////////////  FIN de los opciones //////////////////////////
...
$cabeceras 		= "	<th>Categorias</th>
					<th>Temporadas</th>
					<th>Cant.Max.Jugad.</th>
					<th>Cant.Min.Jugad.</th>
					<th>Dias</th>
					<th>Hora</th>
					<th>Minutos Part.</th>
					<th>Cant.Cambios x Partidos</th>
					<th>Con Reingreso</th>
					<th>Obs.</th>";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerDefinicionescategoriastemporadas(),10);
