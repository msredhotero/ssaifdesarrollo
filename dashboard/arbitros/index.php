...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../arbitros/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Arbitros",$_SESSION['refroll_predio'],$_SESSION['email_predio']);
...
$cadRef 	.= $serviciosFunciones->devolverSelectBox($resUsuarios,array(1),'');
...
$(document).ready(function(){
	var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=arbitros",
			"language": {
