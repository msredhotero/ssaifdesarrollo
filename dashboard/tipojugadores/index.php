...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../tipojugadores/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Tipo Jugadores",$_SESSION['refroll_predio'],$_SESSION['email_predio']);


/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Tipo Jugador";

$plural = "Tipo Jugadores";

$eliminar = "eliminarTipojugadores";

$insertar = "insertarTipojugadores";
...
$tabla 			= "tbtipojugadores";

$lblCambio	 	= array("tipojugador");
$lblreemplazo	= array("Tipo Jugador");
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerTipojugadores(),2);
