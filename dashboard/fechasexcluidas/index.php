...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../fechasexcluidas/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Fechas Excluidas",$_SESSION['refroll_predio'],$_SESSION['email_predio']);


/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Fecha Excluida";

$plural = "Fechas Excluidas";

$eliminar = "eliminarFechasexcluidas";

$insertar = "insertarFechasexcluidas";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerFechasexcluidas(),2);
