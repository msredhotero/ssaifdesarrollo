...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../puntosbonus/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Punto Bonus",$_SESSION['refroll_predio'],$_SESSION['email_predio']);


/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Punto Bonus";

$plural = "Punto Bonus";

$eliminar = "eliminarPuntobonus";

$insertar = "insertarPuntobonus";
...
$lblCambio	 	= array("cantidadfechas","valoracomparar","puntosextra");
$lblreemplazo	= array("Cant. Fechas","Valor a Comparar","Puntos Extras");
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerPuntobonus(),6);
