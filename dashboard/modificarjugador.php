...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Dashboard",$_SESSION['refroll_predio'],$_SESSION['email_predio']);
...
$lblCambio	 	= array("reftipodocumentos","nrodocumento","fechanacimiento","fechaalta","fechabaja","refcountries","refusuarios","numeroserielote");
$lblreemplazo	= array("Tipo Documento","Nro Documento","Fecha Nacimiento","Fecha Alta","Fecha Baja","Countries","Usuario","Nro Serie Lote");
...
$resUsua = $serviciosUsuario->traerUsuarioId(mysql_result($resResultado,0,'refusuarios'));
$cadRef3j 	= $serviciosFunciones->devolverSelectBox($resUsua,array(3),'');

$refdescripcion = array(0 => $cadRefj,1 => $cadRef2j,2 => $cadRef3j);
...
<h3><?php echo $plural; ?></h3>
    ...
    <div class="boxInfoLargo">
    	...
    	<div class="cuerpoBox">
			...
			<div class="row">
			<?php echo $formulario; ?>
			<input type="hidden" name="nrodocumento" id="nrodocumento" value="<?php echo mysql_result($resResultado,0,'nrodocumento'); ?>">
            </div>
