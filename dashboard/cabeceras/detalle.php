...
<div id="content">
    ...
    <div class="boxInfoLargo">
    	...
    	<div class="cuerpoBox">
			...
			<button type="button" class="btn btn-success aprobarMasivo" style="margin-left:0px;">Aprobar Masivo</button>
			<button type="button" class="btn btn-danger rechazarMasivo" style="margin-left:0px;">Rechazar Masivo</button>
			<button type="button" class="btn btn-primary iniciarMasivo" style="margin-left:0px;">Iniciar Masivo</button>
    		<br>
...
$(document).ready(function(){
	...
	function aprobarMasivoEquiposDelagados(idestado) {
		$.ajax({
			data:  {idcabecera: <?php echo $id; ?>,
					idestado: idestado,
					accion: 'aprobarMasivoEquiposDelagados'},
			url:   '../../ajax/ajaxdelegados.php',
			type:  'post',
			beforeSend: function () {
	...
	$('.aprobarMasivo').click(function() {
		aprobarMasivoEquiposDelagados(3);
	});

	$('.rechazarMasivo').click(function() {
		aprobarMasivoEquiposDelagados(4);
	});
