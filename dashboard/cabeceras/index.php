...
$(document).ready(function(){
	...
	function traerCabecera() {
		$.ajax({
			data:  {dato: 'cabeceras', 
					cabecerasdatos: 'temporada,countrie,estado,fechacrea',
					id: 'idcabeceraconfirmacion',
					accion: 'armarTable'
			},
	...
	function modificarEstadoCabecera(id,estado) {
		$.ajax({
			data:  {id: id, 
					idestado: estado,
					accion: 'modificarEstadoCabecera'},
			url:   '../../ajax/ajaxdelegados.php',
			type:  'post',
			beforeSend: function () {
	...
	$('#btnModificarEstado').click(function() {
		modificarEstadoCabecera($('#idcabecera').val(), $('#refestados').val() );
	});
