...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../contactos/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Contactos",$_SESSION['refroll_predio'],$_SESSION['email_predio']);
