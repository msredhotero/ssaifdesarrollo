...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_predio'], '../tipossanciones/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Tipos Sanciones",$_SESSION['refroll_predio'],$_SESSION['email_predio']);


$id = $_GET['id'];

$resResultado = $serviciosReferencias->traerTiposancionesPorId($id);
...
$modificar = "modificarTiposanciones";

$idTabla = "idtiposancion";
