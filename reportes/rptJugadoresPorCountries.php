...
$pdf->Cell(200,5,'ACTUALIZACIÓN DE DATOS AÑO 2017',0,0,'C',false);
$pdf->Ln();
$pdf->Ln();
$pdf->Ln();
...
$pdf->Ln();
$pdf->Ln();
$pdf->Cell(200,5,'1º DELEGADO:',0,0,'L',false);
$pdf->Ln();
$pdf->Cell(200,5,'NÚMERO PARTICULAR:',0,0,'L',false);
$pdf->Ln();
$pdf->Cell(200,5,'NÚMERO LABORAL:',0,0,'L',false);
$pdf->Ln();
$pdf->Cell(200,5,'NÚMERO DE CELULAR:',0,0,'L',false);
$pdf->Ln();
$pdf->Cell(200,5,'E-MAIL:',0,0,'L',false);
$pdf->Ln();
$pdf->Ln();
$pdf->Cell(200,5,'2º DELEGADO:',0,0,'L',false);
$pdf->Ln();
$pdf->Cell(200,5,'NÚMERO PARTICULAR:',0,0,'L',false);
$pdf->Ln();
$pdf->Cell(200,5,'NÚMERO LABORAL:',0,0,'L',false);
...
$pdf->Cell(200,5,'Año: _____		',0,0,'L',false);$pdf->Ln();
...
$pdf->Cell(200,5,'Categoría: ______________________________',0,0,'L',false);$pdf->Ln();
$pdf->Ln();
$pdf->Cell(200,5,'Dirección de la Administración: _________________________________________________________________________',0,0,'L',false);$pdf->Ln();$pdf->Ln();
$pdf->SetFont('Arial','',10);
$pdf->Cell(200,5,'Localidad: __________________________  Código Postal: _____  Tel.: __________________  Fax: ___________________',0,0,'L',false);$pdf->Ln(); 
$pdf->Cell(200,5,'E-mail: _________________________________________________',0,0,'L',false);$pdf->Ln();
$pdf->SetFont('Arial','b',10);
$pdf->Cell(200,5,'Dirección del Country: _________________________________________________________________________________',0,0,'L',false);$pdf->Ln();$pdf->Ln();
$pdf->SetFont('Arial','',10);
$pdf->Cell(200,5,'Localidad: __________________________  Código Postal: _____  Tel.: __________________  Fax: ___________________',0,0,'L',false);$pdf->Ln(); 
$pdf->Cell(200,5,'E-mail: _________________________________________________',0,0,'L',false);$pdf->Ln();$pdf->Ln();
$pdf->Cell(200,5,'Condición de IVA: _____________________	CUIT: ______________________',0,0,'L',false);$pdf->Ln();$pdf->Ln();
$pdf->SetFont('Arial','b',10);
...
$pdf->Cell(200,5,'Camisetas (detallar colores y descripción):',0,0,'L',false);$pdf->Ln();$pdf->Ln();
$pdf->SetFont('Arial','',10);
...
$pdf->Cell(50,5,'Teléfono',0,0,'L',false);
$pdf->Cell(50,5,'____________________',0,0,'L',false);
$pdf->Cell(50,5,'____________________',0,0,'L',false);
$pdf->Cell(50,5,'____________________',0,0,'L',false);
$pdf->Ln();
...
$pdf->Cell(50,5,'Ubicación dentro del club',0,0,'L',false);
$pdf->Cell(50,5,'____________________',0,0,'L',false);
$pdf->Cell(50,5,'____________________',0,0,'L',false);
$pdf->Cell(50,5,'____________________',0,0,'L',false);
$pdf->Ln();
...
$pdf->SetFont('Arial','b',8);
$pdf->Cell(200,5,'Nota: Se deberá adjuntar un croquis con la ubicación de las canchas habilitadas dentro del country',0,0,'L',false);$pdf->Ln();$pdf->Ln();
$pdf->SetFont('Arial','b',10);
$pdf->Ln();
...
$pdf->Cell(60,5,'Teléfono y e-mail',0,0,'L',false);
$pdf->Cell(70,5,'______________________________',0,0,'L',false);
$pdf->Cell(70,5,'______________________________',0,0,'L',false);
$pdf->Ln();
