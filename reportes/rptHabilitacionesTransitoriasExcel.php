...
$tituloReporte = "Habilitaciones Transitorias";
$tituloReporte2 = "Temporada: ".$nombre;
$titulosColumnas = array("Apellido y Nombre", "Nro.Doc.","Fec. Limite", "Motivo","Club");
...
header('Content-Disposition: attachment;filename="rptHabilitacionesTransitorias.xlsx"');
